...
namespace UniversalOptimizer.Algorithm.Exact.TotalEnumeration
{
    ...
    public delegate void ProblemSolutionTeSupportResetMethod<R_co, A_co>(Problem problem, Solution<R_co, A_co> solution, Algorithm<R_co, A_co> optimizer) ;
    public delegate void ProblemSolutionTeSupportProgressMethod<R_co, A_co>(Problem problem, Solution<R_co, A_co> solution, Algorithm<R_co, A_co> optimizer) ;
    public delegate bool ProblemSolutionTeSupportCanProgressMethod<R_co, A_co>(Problem problem, Solution<R_co, A_co> solution, Algorithm<R_co, A_co> optimizer) ;
    public delegate long ProblemSolutionTeSupportOverallNumberOfEvaluationsMethod<R_co, A_co>(Problem problem, Solution<R_co, A_co> solution, Algorithm<R_co, A_co> optimizer) ;
    ...
    public interface IProblemSolutionTeSupport<R_co, A_co> 
    {
        ...
        public void Reset(Problem problem, Solution<R_co, A_co> solution, Algorithm<R_co, A_co> optimizer);
        ...
        /// <param name="solution">The solution used for the problem that is solved.</param>
        /// <param name="optimizer">The optimizer that is executed.</param>
        public void Progress(Problem problem, Solution<R_co, A_co> solution, Algorithm<R_co, A_co> optimizer);
        ...
        /// </returns>
        public bool CanProgress(Problem problem, Solution<R_co, A_co> solution, Algorithm<R_co, A_co> optimizer);
        ...
        /// <param name="optimizer">The optimizer that is executed.</param>
        /// <returns></returns>
        public long OverallNumberOfEvaluations(Problem problem, Solution<R_co, A_co> solution, Algorithm<R_co, A_co> optimizer);
    }
}
