///  
/// The :mod:`~opt.SingleObjective.Teaching.OnesCountProblem.command_line` module is used for obtaining execution parameters for execution of the optimizers for max ones problem.
/// 
    ...
    public static class command_line {
        ...
        public static void parse_arguments() {
            ...
            parser_vns.add_argument("--solutionType", type: str, choices: new List<string> {
                "BitArray",
                "int"
            }, @default: "BitArray", help: "VNS parameter that determines solution (representation) type.");
            parser_vns.add_argument("--log", @default: "warning", help: "Provide logging level. Example --log debug', default='warning'");
            var parser_te = subparsers.add_parser("total_enumeration", help: "Execute total enumeration algorithm for ones_count_problem.");
            parser_te.add_argument("optimization_type", help: "Decide if minimization or maximization will be executed.", nargs: "?", choices: ("minimization", "maximization"));
            ...
            parser_te.add_argument("--solutionType", type: str, choices: new List<string> {
                "BitArray",
                "int"
            }, @default: "BitArray", help: "TE parameter that determines solution (representation) type.");
            parser_te.add_argument("--log", @default: "warning", help: "Provide logging level. Example --log debug', default='warning'");
            var parser_ilp = subparsers.add_parser("integer_linear_programming", help: "Execute ILP solver for ones_count_problem.");
            parser_ilp.add_argument("optimization_type", help: "Decide if minimization or maximization will be executed.", nargs: "?", choices: ("minimization", "maximization"));
            ...
            parser_ilp.add_argument("--log", @default: "warning", help: "Provide logging level. Example --log debug', default='warning'");
