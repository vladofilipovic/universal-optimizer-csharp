...
/// 
/// The :mod:`~opt.SingleObjective.Teaching.OnesCountProblem.ones_count_problemBinaryIntSolution` contains class :class:`~opt.SingleObjective.Teaching.OnesCountProblem.ones_count_problemBinaryIntSolution.OnesCountProblemBinaryIntSolution`, that represents solution of the :ref:`Problem_Max_Ones`, where `int` representation of the problem has been used.
/// 
